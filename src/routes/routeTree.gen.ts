...
//
// MANUALLY CORRECTED AGAIN on 2026-07-29: added the new AI Product Console
// routes (src/routes/admin.ai-console.tsx, src/routes/api.ai-console.ts) —
// same regeneration gap as above.
